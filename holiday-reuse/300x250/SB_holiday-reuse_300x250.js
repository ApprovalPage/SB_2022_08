...
(lib.holidayreuse300x2502x = function() {
	this.initialize(ss["SB_holiday_reuse_300x250_atlas_1"]);
	this.gotoAndStop(4);
}).prototype = p = new cjs.Sprite();
...
}).prototype = getMCSymbolPrototype(lib.HEAD, new cjs.Rectangle(0,0,220,64.5), null);
...
// stage content:
(lib.SB_holidayreuse_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(127.5,237.65,1,1,0,0,0,113.5,148.7);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).to({regY:148.6,y:217.6,alpha:1},10,cjs.Ease.quadOut).wait(81));
