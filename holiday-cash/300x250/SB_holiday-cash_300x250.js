...
lib.ssMetadata = [
		{name:"SB_holiday_cash_300x250_atlas_1", frames: [[0,566,354,76],[0,502,510,62],[602,318,370,238],[512,558,298,95],[0,0,600,500],[602,0,371,316]]}
];
...
(lib.CachedBmp_48 = function() {
	this.initialize(ss["SB_holiday_cash_300x250_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.holidaycash300x2502x = function() {
	this.initialize(ss["SB_holiday_cash_300x250_atlas_1"]);
	this.gotoAndStop(4);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib.SB_holidaycash_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// BKGD
	this.instance_5 = new lib.holidaycash300x2502x();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/SB_holiday_cash_300x250_atlas_1.png?1668111065539", id:"SB_holiday_cash_300x250_atlas_1"}
	],
	preloads: []
};
