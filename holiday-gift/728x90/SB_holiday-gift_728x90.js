...
(lib.CachedBmp_20 = function() {
	this.initialize(ss["SB_holiday_gift_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.HEAD, new cjs.Rectangle(0,0,449,68), null);
...
// stage content:
(lib.SB_holidaygift_728x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// BKGD
	this.instance_5 = new lib.holidaygift728x902x();
