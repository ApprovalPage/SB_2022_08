...
}).prototype = getMCSymbolPrototype(lib.HEAD, new cjs.Rectangle(0,0,151.6,160), null);
...
// stage content:
(lib.SB_wedding_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(129.85,159.35,1.0723,1.0723,0,0,0,113.5,148.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(342));

	// TAG
	this.instance_1 = new lib.TAG();
	this.instance_1.setTransform(88.35,181.75,0.7364,0.7364,0,0,0,104.1,18.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(342));

	// CTA
	this.instance_2 = new lib.CTA();
	this.instance_2.setTransform(83.35,215.1,0.7316,0.7316,0,0,0,99.7,25.9);
